...
function get_jwt_preview(id, species, res_time, get_zip, dtap, newWindow){
    query_string = "http://" + HOSTANDPORT + "/search?isolate_id=" + id + '&res_version=' + res_time +"&species=" + species + "&get_zip=" + get_zip + "&dtap=" + dtap
...
function get_jwt_zip(id, species, res_time, get_zip, dtap, newWindow){
    query_string = "http://" + HOSTANDPORT + "/search?isolate_id=" + id + '&res_version=' + res_time +"&species=" + species + "&get_zip=" + get_zip + "&dtap=" + dtap
    $.ajax( query_string , {
        method: 'GET',
        headers: {"x-access-token": localStorage.getItem('token')},
...
function get_jwt_report (get_zip){
    ...
    var loadingMessage = 'Retrieving your report, please wait...';
    newWindow.document.write(loadingMessage);
    ...
    dt.forEach((el, index) => {
     ...
     $.ajax({
        ...
        complete: function(){
            if(get_zip === 'yes'){
                get_jwt_zip(id, species, res_version, get_zip, dtap, newWindow)
            }else{
                 get_jwt_preview(id, species, res_version, get_zip, dtap, newWindow)
            }
        },
        dataType: 'json'
    });
