...
class GetCoreQCMetrics:
    ...
    def get_sample_coreqc_metrics(self) -> dict[str, Any]:
        ...
        if self._original_input_format == 'fasta':
            ...
            self.__set_ont_contamination_thresholds(sample_coreqc_metrics)
