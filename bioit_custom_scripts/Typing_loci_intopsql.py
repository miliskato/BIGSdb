...
schemedict  = { 'salmonella_mlst': {'dirdb': '/db/sequence_typing/salmonella/mlst', 'schemename_bigsdb': 'MLST', 'seqdefdb': 'bigsdb_salmonella_seqdef', 'isolatedb': 'bigsdb_salmonella_isolates'},
...
#               'listeria_cgmlst': {'dirdb': '/db/sequence_typing/listeria/cgmlst', 'schemename_bigsdb': 'cgMLST', 'seqdefdb': 'bigsdb_listeria_seqdef', 'isolatedb': 'bigsdb_listeria_isolates'},
#               'listeria_mlst': {'dirdb': '/db/sequence_typing/listeria/mlst', 'schemename_bigsdb': 'MLST', 'seqdefdb': 'bigsdb_listeria_seqdef', 'isolatedb': 'bigsdb_listeria_isolates'},
#               'listeria_cgmlst': {'dirdb': '/db/sequence_typing/listeria/cgmlst', 'schemename_bigsdb': 'cgMLST', 'seqdefdb': 'bigsdb_listeria_seqdef', 'isolatedb': 'bigsdb_listeria_isolates'},
