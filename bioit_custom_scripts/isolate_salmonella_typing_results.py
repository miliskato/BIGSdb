...
schemedict = {'salmonella_mlst': {'dirdb': '/db/sequence_typing/salmonella/mlst', 'tsvname': 'mlst'},
              ...
              'salmonella_pointfinder': {'dirdb': '', 'tsvname': 'pointfinder_mutations',
                                         'schemename_html': 'PointFinder'},
...
if sample_presence[0][0] == 0:
    ...
    cur.execute(
        f"SELECT COUNT(*) FROM allele_designations WHERE isolate_id = (SELECT MAX(id) FROM isolates WHERE isolate='{isolate_name}')")
