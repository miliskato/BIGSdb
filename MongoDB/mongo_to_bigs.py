    ...
    try:
        ...
        with DatabaseConnection(species, 'isolates') as isolates_psql_db, DatabaseConnection(species, 'seqdef') as seqdef_psql_db:
            ...
            for document in listofdocuments:
                ...
                sample_presence = isolates_psql_db.execute_query(sqlquery, (document['results']['isolates_id'],))
                if sample_presence[0][0] == 0:
                    ...
                    latest_analysis_date_bigs = (isolates_psql_db.execute_query(sqlquery, (document['results']['isolates_id'],)))[0][0]  # this appearently is a datetime object
                    ...
                    mongo_results_changed_version_bigs_query = isolates_psql_db.execute_query(sqlquery, (document['results']['isolates_id'],))
                ...
                if results_type == 'new_isolate':
                    ...
                    last_two_validation_dates = isolates_psql_db.execute_query(sqlquery, (document['results']['isolates_id'],))
                    ...
                    if last_two_validation_dates[0][0] != last_two_validation_dates[1][0]:
                        ...
                        isolates_psql_db.execute_query(sqlquery, (document['results']['isolates_id'], document['results']['isolates_id']))
                        sqlquery = """
