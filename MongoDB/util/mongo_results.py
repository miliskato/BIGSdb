        ...
        if species in self._species_options:
            ...
            if species == "listeria":
                ...
                records = {"isolate": outputtsvdict["sample"],
                            ...
                            "analysis_date": outputtsvdict["analysis_date"],
                ...
                records = {"isolate": outputtsvdict["sample"],
                            ...
                            "variant_calling": self._avro_input_commontsvoutput(outputtsvdict, "variant_calling"),
                            "variant_filtering": self._avro_input_commontsvoutput(outputtsvdict, "variant_filtering"),
                            "mlst_pasteur": self._avro_input_typingschema(species, "mlst_pasteur", "mlst-pasteur", outputtsvdict),
                            "mlst_warwick": self._avro_input_typingschema(species, "mlst_warwick", "mlst-warwick", outputtsvdict),
                            "cgmlst": self._avro_input_typingschema(species, "cgmlst", "cgmlst", outputtsvdict),
                            "hits_ncbi_amr": outputtsvdict["hits_ncbi_amr"],
                            "hits_resfinder": outputtsvdict["hits_resfinder"],
                            "hits_virulencefinder": outputtsvdict["hits_virulencefinder"],
                ...
                self._common_output_arguments["genotyphi"] = ['genotyphi_ESBLs_susceptibility', 'genotyphi_ESBLs_variants', 'genotyphi_ESBLs_genes', 'genotyphi_IncFIAHI1_susceptibility', 'genotyphi_IncFIAHI1_variants', 'genotyphi_IncFIAHI1_genes', 'genotyphi_IncHI1A_susceptibility', 'genotyphi_IncHI1A_variants', 'genotyphi_IncHI1A_genes', 'genotyphi_IncHI1BR27_susceptibility', 'genotyphi_IncHI1BR27_variants', 'genotyphi_IncHI1BR27_genes', 'genotyphi_IncY_susceptibility', 'genotyphi_IncY_variants', 'genotyphi_IncY_genes', 'genotyphi_aminoglycosides_susceptibility', 'genotyphi_aminoglycosides_variants', 'genotyphi_aminoglycosides_genes', 'genotyphi_azithromycin_susceptibility', 'genotyphi_azithromycin_variants', 'genotyphi_azithromycin_genes', 'genotyphi_beta-lactamases_susceptibility', 'genotyphi_beta-lactamases_variants', 'genotyphi_beta-lactamases_genes', 'genotyphi_macrolides_susceptibility', 'genotyphi_macrolides_variants', 'genotyphi_macrolides_genes', 'genotyphi_pST_susceptibility', 'genotyphi_pST_variants', 'genotyphi_pST_genes', 'genotyphi_phenicols_susceptibility', 'genotyphi_phenicols_variants', 'genotyphi_phenicols_genes', 'genotyphi_quinolones_susceptibility', 'genotyphi_quinolones_variants', 'genotyphi_quinolones_genes', 'genotyphi_sulfonamides_susceptibility', 'genotyphi_sulfonamides_variants', 'genotyphi_sulfonamides_genes', 'genotyphi_tetracyclines_susceptibility', 'genotyphi_tetracyclines_variants', 'genotyphi_tetracyclines_genes', 'genotyphi_trimethoprims_susceptibility', 'genotyphi_trimethoprims_variants', 'genotyphi_trimethoprims_genes', 'genotyphi_z66_susceptibility', 'genotyphi_z66_variants', 'genotyphi_z66_genes', 'genotyphi_phylo_group', 'genotyphi_species', 'genotyphi_lineage', 'genotyphi_phylo_group_per_covg', 'genotyphi_species_per_covg', 'genotyphi_lineage_per_covg', 'genotyphi_phylo_group_depth', 'genotyphi_species_depth', 'genotyphi_lineage_depth']
                self._common_output_arguments["sistr"] = ['sistr_hits_serotype_h1_fliC', 'sistr_hits_serotype_h2_fljB', 'sistr_hits_serotype_o_wzx', 'sistr_hits_serotype_o_wzy', 'sistr_serotype_antigenic_formula', 'sistr_serotype_serogroup', 'sistr_serotype_concensus']
                self._common_output_arguments["seqsero2_kmer"] = ['seqsero2_kmer O antigen prediction:', 'seqsero2_kmer H1 antigen prediction(fliC):', 'seqsero2_kmer H2 antigen prediction(fljB):', 'seqsero2_kmer Predicted identification:', 'seqsero2_kmer Predicted antigenic profile:', 'seqsero2_kmer Predicted serotype:']
                self._common_output_arguments["seqsero2_allele"] = ['seqsero2_allele O antigen prediction:', 'seqsero2_allele H1 antigen prediction(fliC):', 'seqsero2_allele H2 antigen prediction(fljB):', 'seqsero2_allele Predicted identification:', 'seqsero2_allele Predicted antigenic profile:', 'seqsero2_allele Predicted serotype:']
                self._common_output_arguments["seqsero2_kmerread"] = ['seqsero2_kmerread O antigen prediction:', 'seqsero2_kmerread H1 antigen prediction(fliC):', 'seqsero2_kmerread H2 antigen prediction(fljB):', 'seqsero2_kmerread Predicted identification:', 'seqsero2_kmerread Predicted antigenic profile:', 'seqsero2_kmerread Predicted serotype:']
                records = {"isolate": outputtsvdict["sample"],
                            "pipeline_version": outputtsvdict["pipeline_version"],
                            "analysis_date": outputtsvdict["analysis_date"],
                            "downsampling": self._avro_input_commontsvoutput(outputtsvdict, "downsampling"),
