...
class MainResultsInserter:
    def __init__(self, isolatename: str, uploader_mail_address: str, species: str, results_type: str, report_access: str, vcf_path: str, mongo_dtap: str,
    ...
    def _main_results_inserter(self) -> None:
        ...
        maininserter = MainInserter(self._isolatename, self._species, sample_output_dict, self._bigsdb_config_data, self._report_access, self._vcf_path, self._mongo_dtap)
...
if __name__ == '__main__':
    ...
    # run main
    MainResultsInserter(args.isolatename, args.uploader_mail_address, args.species, args.results_type, args.report_access, jsonfilepath=(args.jsonfilepath if args.jsonfilepath else None), tsvfilepath=(args.tsvfilepath if args.tsvfilepath else None))
