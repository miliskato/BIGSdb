...
INSERT INTO eav_fields(field, value_format, category, description, no_curate, no_submissions, datestamp, curator) VALUES('nextclade_clade', 'text', 'Nextclade', '', 't', 't', (SELECT CURRENT_DATE), 1) ON CONFLICT DO NOTHING;
