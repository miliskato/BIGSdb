...
max_value int,
field_order int,
no_curate boolean NOT NULL,
no_submissions boolean NOT NULL,
datestamp date NOT NULL,
curator int NOT NULL,
PRIMARY KEY (field),
...
PRIMARY KEY (isolate_id,field),
CONSTRAINT eavb_isolate FOREIGN KEY (isolate_id) REFERENCES isolates
ON DELETE CASCADE
ON UPDATE CASCADE,
CONSTRAINT eavb_field FOREIGN KEY (field) REFERENCES eav_fields
ON DELETE CASCADE
ON UPDATE CASCADE
);
